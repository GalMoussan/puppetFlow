...
Follow `.Codex/skills/company-execute/SKILL.md`, but execute ONLY the runner-free
...
```
Default `Codex` agent type. Do NOT set `model`.
...
Follow `.Codex/skills/company-execute/SKILL.md`.
Blueprint ID: {id}  (state file: Company/project/pipelines/{id}.md)
...
Follow `.Codex/skills/company-execute/SKILL.md`. Execute ONLY the runner-free post-code work:
